...
private:
    ...
    visualization_msgs::Marker mReferencePoints; // 생성자가 만들어질 때는 구성성분 대입되지 않는다
    visualization_msgs::Marker mKeyFrames;           // 파란색
    visualization_msgs::Marker mReferenceKeyFrames; // 빨간색
    visualization_msgs::Marker mCovisibilityGraph;
    visualization_msgs::Marker mMST;
    visualization_msgs::Marker mCurrentCamera;		// 초록색
